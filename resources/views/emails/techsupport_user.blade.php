...
<body>
    <div class="container" style="max-width:750px !important;">
        ...
        <div class="content">
            <h3>Dear {{ $attributes['user'] }},</h3>
            <h3 style="margin-bottom: 10px;">Your query <strong style="font-weight: 800;">{{ $attributes['query'] }}</strong> has been received and will be addressed shortly.</h3>
            
            <h3>For any further queries kindly contact us on 8070 400 900 or write to us on helpdesk@jkshahclasses.com</h3>
            <h3>Regards,<br>Team J. K. Shah</h3><br><br>
