...
<body>
    <div class="container" style="max-width:750px !important;">
        ...
        <div class="content">
            <h3>Hello {{ $attributes['user_name'] }},</h3>
            <h3 style="margin-bottom: 10px;"><strong style="font-weight: 800;">{{ $attributes['professor_name'] }}</strong> has answered your question about the video <strong>{{ $attributes['video_name'] }}</strong> in <strong>{{ $attributes['package_name'] }}</strong> package.</h3>
            <h3>Q: <strong style="font-weight: 800;">{!! $attributes['question'] !!}</strong></h3>
            <h3>A: <strong style="font-weight: 800;">{!! $attributes['answer'] !!}</strong></h3>
            <h3>Best Regards,<br>JKSHAH Online</h3><br>
