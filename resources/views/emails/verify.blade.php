...
<table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <td class="innerpadding borderbottom" style="padding-top: 0px;">
            ...
            <br />
            <br />
            Click the button below to verify your JKSHAH account.
            <br />
            <br />
            <a href="{{ $attributes['verification_url'] }}" style="background-color: #f58457; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;">VERIFY ACCOUNT</a>
            <br />
            <br />
        </td>
    <tr>
