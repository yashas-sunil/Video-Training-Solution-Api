...
<table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
            ...
            <table width="70" align="center" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                   <td height="70" style="padding: 0 20px 20px 0;">
                        <a href="{{ $attributes['web_url'] }}"><img class="fix" src="<?php echo $message->embed($attributes['logo_url']); ?>" width="150" border="0" alt=""></a> 
                    </td> 
                </tr>
                </tbody></table>
        </td>
    ...
    <tr>
        <td class="innerpadding" align="center" style="font-family: 'Ubuntu Mono', sans-serif; font-size: 15px; line-height: 20px; padding: 10px 0 10px 0;">
            For more, <a href="{{ $attributes['web_url'] }}">{{ $attributes['web_url']  }}</a>
        </td>
    </tr>
    <tr>
