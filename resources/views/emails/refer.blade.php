...
<table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
            ...
            <table width="70" align="center" border="0" cellpadding="0" cellspacing="0">
                <tbody><tr>
                    <td height="70" style="padding: 0 20px 20px 0;">
                        <a href="{{ $referral['web'] }}"> <img class="fix"  src="<?php echo $message->embed($referral['logo']); ?>"  width="150" border="0" alt=""></a>
                    </td>
                </tr>
                </tbody></table>
        </td>
    ...
    <tr>
        <td class="innerpadding borderbottom" style="padding-top: 0px;">
            ...
            <br />
            <br />
            You've been invited by {{ $referral['user'] }} to join JKSHAH, a web-based learning platform.
            <br />
            <br />
            Click the button below to finish setting up your JKSHAH account or use this <a href="{{ $referral['url'] }}">link</a>.
            <br />
            We'll log you in right away.
            <br />
            <br />
            <a href="{{ $referral['url'] }}" style="background-color: #f58457; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;">Activate account</a>
            <br />
            <br />
        </td>
    <tr>
