...
<table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        <td class="innerpadding borderbottom" style="padding-top: 0px;">
            ...
            <br />
            <br />
            Please enter this otp to update your profile.
            <br />
            <h2>{{$attributes['otp']}}</h2>
            <br />
            If this was not initiated by you, please let us know.
            <br />
            <br />
    ...
    <tr>
        <td class="innerpadding" align="center" style="font-family: 'Ubuntu Mono', sans-serif; font-size: 15px; line-height: 20px; padding: 10px 0 10px 0;">
            For more, <a href="{{ $attributes['web'] }}">{{ $attributes['web'] }}</a>
        </td>
    </tr>
    <tr>
