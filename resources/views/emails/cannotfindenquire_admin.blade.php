...
<body>
    <div class="container" style="max-width:750px !important;">
        ...
        <div class="content">
            <h3>Dear Admin,</h3>
            <h3 style="margin-bottom: 10px;">Student has raised the following query.<strong style="font-weight: 800;"></strong></h3>
            <h3>Student Name:{{$attributes['fname']}}&nbsp;&nbsp;{{$attributes['lname']}}<h3>
            <h3>Email: {{$attributes['email']}}<h3>
            <h3>Phone: {{$attributes['phone']}}<h3>
            <h3>Query: {{$attributes['query']}}<h3>
            <h3>Thank You!</h3>
